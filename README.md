...
Сервис для загрузки медицинских документов (PDF/изображения), их структурированного хранения и AI-анализа.
Ключевая цель - предиктивная аналитика возможных заболеваний. 
---
